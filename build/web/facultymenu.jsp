<%-- 
    Document   : facultymenu
    Created on : Feb 22, 2011, 11:14:35 AM
...
%><br>
       ...
       <br><br>
        <div align="center">
            <img src="faculty.jpg" alt="" height="279" width="430">
       ...
       <form action="./viewCourseInfo" method="post"><input type="hidden" name="lgn" value=<%=z %>><input type="hidden" name="pwd" value=<%=z1 %>><input type="submit" name="submit" value="View Course Information"></form>
            ...
            <form action="postQueryAnswer.jsp" method="post"><input type="hidden" name="lgn" value=<%=z %>><input type="hidden" name="pwd" value=<%=z1 %>><input type="submit" name="submit" value="View posted Queries and Provide Answers"></form>
